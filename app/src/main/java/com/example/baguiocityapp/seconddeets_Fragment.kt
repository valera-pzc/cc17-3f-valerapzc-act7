...
class seconddeets_Fragment : Fragment() {
    override fun onCreateView(
        ...
        backBtn.setOnClickListener { it.findNavController().navigate(R.id.action_seconddeets_Fragment_to_secondcategoryfragment) }
