...
class firstadapter(private val dataList: ArrayList<DataClass>): RecyclerView.Adapter<firstadapter.ViewHolderClass>() {
    ...
    override fun onBindViewHolder(holder: ViewHolderClass, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            it.findNavController().navigate(R.id.action_categoryOneFragment_to_firstdeets_Fragment, bundle)
        }
